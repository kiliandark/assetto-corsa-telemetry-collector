...
На форуме у нас был стенд с классическим набором: лекторий, мерч, разговоры про безопасность и аналитику. Но был и козырь в рукаве — полноценный гоночный симулятор с подвижной платформой. 
...
С технической стороны это был полноценный гоночный симулятор: игровой ПК с **Assetto Corsa** (2014), гоночный кокпит (руль с педалями, кресло и подвижная платформа). Софт состоял из самой игры и нашей программы для чтения телеметрии (далее — коллектор).
...
Каждое событие содержало два блока:
- **session** 
- **metrics** 

1. Пример блока `session`:
...
[session_1.png](img/session_1.png)
...
[session_2.png](img/session_2.png)

## Почему это сработало

Самое интересное — люди, ожидавшие своей очереди, начинали следить за результатами других, обсуждать ошибки и спорить. Особенно порадовали фанаты автоспорта: разговоры про траектории, апексы, трейл-брейкинг и оптимальную скорость в поворотах звучали постоянно.

С технической точки зрения это был простой поток телеметрии. С точки зрения гостей стенда — полноценный гоночный опыт с аналитикой, статистикой и элементом соревнования.
